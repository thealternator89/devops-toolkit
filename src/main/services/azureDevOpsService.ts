...
export class AzureDevOpsService {
  ...
  constructor(private org: string, private pat: string) {}
  ...
  async addComment(ticketId: string, text: string) {
    ...
    return witApi.updateWorkItem(undefined, document as any, parseInt(ticketId));
  }

  async addChildTask(parentTicketId: string, title: string, description: string) {
    const witApi = await this.getApi();
